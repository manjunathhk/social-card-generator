...
![First view of the app: an empty editor on the left and a blank card preview on the right](images/guide/01-first-view.png)
...
![The example dropdown open, showing a list of ready-made cards to choose from](images/guide/02-example-picker.png)
...
![An example loaded, showing formatted title, code snippet and preview panel](images/guide/03-example-loaded.png)
...
![The Branding panel expanded, showing optional fields like Author, Website, LinkedIn and Twitter](images/guide/04-branding-panel.png)
...
![The Export PNG buttons below the finished card preview](images/guide/05-export-buttons.png)
...
![The History panel showing a saved card thumbnail](images/guide/06-history-panel.png)
...
![The editor reset to a blank new card after clicking New](images/guide/07-new-card.png)
